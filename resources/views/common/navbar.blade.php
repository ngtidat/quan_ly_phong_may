    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown user-menu">
            ...
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="{{ isset($user->hinh_anh) && !empty($user->hinh_anh) ? asset(pare_url_file($user->hinh_anh)) : asset('/admin/dist/img/avatar5.png') }}" class="user-image img-circle elevation-2" alt="User Image">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    ...
                    <p>
                        ...
                        <small>{!! isset($user->dia_chi) ? $user->dia_chi : '' !!}</small>
                    </p>
                </li>
                <!-- Menu Footer-->
